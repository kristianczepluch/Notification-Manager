...
class LimitNumberDetailsFragment(val ruleId: Int) : Fragment(R.layout.fragment_limit_number_details) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        detailActivityViewModel.getDetoxRuleEntity(ruleId).observe(viewLifecycleOwner, Observer{ rule ->
